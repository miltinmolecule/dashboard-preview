          ...
          <div className="flex-1 space-y-3">
            {[
              ...
              { label: "Color:", value: profile.vehicleColor },
              {
                ...
                value: String(profile.vehicleSeats),
              },
          ...
          <div className="w-56 shrink-0">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="aspect-video rounded-lg bg-gray-100 border border-dashed border-gray-200 flex items-center justify-center"
                >
                  <svg
            ...
            <div key={doc.label} className="text-center">
              <div className="aspect-[3/4] rounded-xl bg-gray-50 border border-gray-200 flex flex-col items-center justify-center mb-2 p-3">
                ...
                <div className="w-full space-y-1">
                  {[1, 2, 3].map((l) => (
                    <div key={l} className="h-1 bg-gray-200 rounded" />
                  ))}
                </div>
              </div>
